...
- ⚛️ Especializando-se em **Next.js** e integração com APIs.
- ⚡ **Performance:** Otimização de Web Vitals com Next.js.
- 🏗️ **Arquitetura:** Clean Architecture em projetos Front-end.
- 🛡️ **Tipagem:** TypeScript avançado para aplicações escaláveis.
